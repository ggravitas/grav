...
return [
    ...
    'filename' => '/Users/jerrybrahm/repos/grav-skeleton-open-blog-space/user/themes/quark-open-publishing/blueprints.yaml',
    'modified' => 1533070814,
    'data' => [
        'name' => 'Quark Open Blog',
        'version' => '1.0.4',
        'description' => 'A customized version of the Quark theme, with Git Sync and \'chromeless\' mode (as shown in screenshot).',
        'icon' => 'unlock',
        'author' => [
